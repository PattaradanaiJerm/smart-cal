...
export async function generateMetadata({
  ...
  return {
    title: isTh
      ? "เครื่องคำนวณออนไลน์ฟรี | Smart Calculator"
      : "Free Online Calculators | Smart Calculator",
    description: isTh
    ...
    openGraph: {
      title: isTh ? "เครื่องคำนวณออนไลน์ฟรี | Smart Calculator" : "Free Online Calculators | Smart Calculator",
      description: isTh
...
function HomeContent() {
  ...
  const faqs = isTh
    ? [
        {
          q: "เว็บนี้ใช้งานฟรีไหม?",
          a: "ฟรี 100% ไม่มีค่าใช้จ่ายใดๆ ทั้งสิ้น ไม่ต้องสมัครสมาชิก",
        },
        {
          q: "คำนวณ BMI คืออะไร?",
          a: "BMI (Body Mass Index) คือดัชนีมวลกาย คำนวณจากน้ำหนัก (กก.) หารด้วยส่วนสูง (เมตร) ยกกำลัง 2 ใช้บ่งชี้น้ำหนักเกินหรือน้อยกว่าเกณฑ์",
        },
        {
          q: "ข้อมูลที่กรอกจะถูกเก็บไหม?",
          a: "ไม่ ข้อมูลทั้งหมดคำนวณในเบราว์เซอร์ของคุณเท่านั้น ไม่มีการส่งข้อมูลไปยังเซิร์ฟเวอร์ใดๆ",
        },
        {
          q: "เครื่องคำนวณสินเชื่อคำนวณยังไง?",
          a: "ใช้สูตรการผ่อนชำระมาตรฐาน (Amortization) โดยคำนวณจากจำนวนเงินกู้ อัตราดอกเบี้ยต่อปี และระยะเวลาผ่อน",
        },
        {
          q: "รองรับบนมือถือไหม?",
          a: "รองรับทุก device ทั้ง PC, tablet และมือถือ ออกแบบแบบ responsive",
        },
      ]
    : [
        {
          q: "Is this website free to use?",
          a: "Yes, 100% free. No subscription, no signup required.",
        },
        {
          q: "What is BMI?",
          a: "BMI (Body Mass Index) is calculated by dividing your weight in kg by your height in meters squared. It indicates whether your weight is in a healthy range.",
        },
        {
          q: "Is my data stored anywhere?",
          a: "No. All calculations happen entirely in your browser. No data is sent to any server.",
        },
        {
          q: "How does the loan calculator work?",
          a: "It uses the standard amortization formula based on loan amount, annual interest rate, and repayment period to calculate monthly payments.",
        },
        {
          q: "Does it work on mobile?",
          a: "Yes, fully responsive — works on PC, tablet, and mobile.",
        },
      ];
  ...
  const websiteSchema = {
    ...
    description: isTh
      ? "รวมเครื่องคำนวณออนไลน์ฟรีกว่า 10 ประเภท"
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <section className="grid grid-cols-3 gap-4 mb-10 px-4">
        {[
          ...
          {
            label: isTh ? "การคำนวณ" : "Calculations",
            value: stats ? formatCount(stats.totalCalculations) : "…",
          },
          {
            label: isTh ? "ผู้เข้าชม" : "Page views",
            value: stats ? formatCount(stats.totalPageViews) : "…",
          },
        ].map((s) => (
          <div
            key={s.label}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {calculators.map((calc) => {
            ...
            return (
              ...
              >
                <span
                  className={`flex items-center justify-center w-10 h-10 rounded-xl text-white shrink-0 ${calc.color}`}
                >
                  <Icon size={20} />
                </span>
